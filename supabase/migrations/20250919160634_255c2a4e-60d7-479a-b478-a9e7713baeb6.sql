-- Create sample project data and admin setup
-- NOTE: Admin user must be created through Supabase Auth UI or API
...
-- Create a function to setup admin user (to be called after auth user is created)
...
-- Create a function to setup client user and project access
